                        ...
                        <form class="form-horizontal" role="form" action="#" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="hidden" name="productNum" value=""> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">產品名稱</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="productName" placeholder="產品姓名" value="greentea"> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                        ...
                                        <a role="button" href="#" class="btn btn-success">新增類別</a> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="productPrice" placeholder="產品價格" value="25"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">產品成本</label>
                                <div class="col-sm-8">
                                    <p class="form-control-static">8</p>
                                    <input type="hidden" name="productCost" value=""> </div>
                            </div>
                            <div class="form-group">
                                <br>
