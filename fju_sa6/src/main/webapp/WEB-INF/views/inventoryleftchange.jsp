...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">修改庫存介面</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <form method="post" action="inventoryleft.jsp" id="insertForm">
                    ...
                    <label>庫存編號:</label>
                        <input type="text" name="desc" placeholder="庫存編號" required>
                        </div>
                        <div class="form-group">
                        <label>庫存項目:</label>
                        <input type="text" name="desc" placeholder="庫存項目" required>
                        
                    </div>
                    <div class="form-group">
                    <label>庫存數量:</label>
                        <input type="text" name="desc" placeholder="庫存數量" required>
                        </div>
