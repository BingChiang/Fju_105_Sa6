...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"
		...
		<div class="col-md-12">
			<br>
			<form class="form-horizontal" role="form" action="supplierAdd"
				method="post">
				<div class="form-group">
					<label class="col-sm-2 control-label">供應商名稱</label>
					<div class="col-sm-8">
						<input type="hidden" name="supplierNum" value=0></input> <input
							type="text" class="form-control" name="supplierName"
							placeholder="輸入供應商名稱" value="">
					</div>
				</div>
				<div class="form-group">
