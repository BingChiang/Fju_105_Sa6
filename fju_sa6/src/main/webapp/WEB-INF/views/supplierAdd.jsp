                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" role="form" action="supplierAdd" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="supplierPhone" placeholder="輸入供應商電話" value=""> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">供應商地址</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="supplierAddress" placeholder="輸入供應商地址" value=""> </div>
                            </div>
                            <div class="form-group">
