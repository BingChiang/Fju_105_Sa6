                        ...
                        <form class="form-horizontal" role="form" action="#" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="hidden" name="inventoryNum" value=""> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">庫存名稱</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="inventoryNmae" placeholder="輸入庫存名稱" value="green"> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    </select> <a role="button" href="#" class="btn btn-success">新增供應商</a> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">庫存數量</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="inventoryAmount" placeholder="輸入庫存數量" value="green"> </div>
                            </div>
                            <div class="form-group">
